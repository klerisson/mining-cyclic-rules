package com.sequential.frequentpatterns.apriori;
...
//		// Pourrait �tre optimis�... en sachant que les listes sont ordonn�es.
//		boolean shareIminus1= true;
//		// ils doivent avoir les premiers i-1 �l�ments en commun
...
//			return null;
//		}
//		if(itemset2.items.get(items.size()-1).equals(items.get(items.size()-1))){ // le dernier �l�ment doit �tre diff�rent!
//			return null;
//		}
