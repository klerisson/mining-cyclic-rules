...
public class AlgoAprioriInverse_saveToFile {
	...
	public void runAlgorithm(double minsup, double maxsup, String output) throws IOException {
	...
	protected List<ItemsetApriori> createLevelWithRareCandidates(double minsup, double maxsup, List<ItemsetApriori> candidatesK) throws IOException {
